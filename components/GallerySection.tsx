...
const images = [
  ...
  {
    id: 5,
    src: "/insta/DSC02146.webp",
    colSpan: "col-span-1",
    rowSpan: "row-span-2",
  },
  {
    id: 6,
    src: "/insta/DSC03171.webp",
    colSpan: "col-span-1",
    rowSpan: "row-span-2",
  },
  {
  ...
  return (
    <section className="relative w-full bg-black/20">
      <div className="relative w-full mx-auto p-1.5 md:p-3">
        ...
        >
          <span className="text-black font-semibold text-sm md:text-lg mb-1 tracking-tight">
            Follow Us on
          </span>
          <span className="text-brand font-bold text-base md:text-xl tracking-wide">
            Instagram
          </span>
        </motion.a>
          ...
          {images.map((img, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors duration-500 flex items-center justify-center z-10">
                <IoLogoInstagram
                  className="w-10 h-10 md:w-12 md:h-12 text-white opacity-0 group-hover:opacity-100 transition-all duration-500 scale-50 group-hover:scale-100"
                  strokeWidth={1.5}
                />
              </div>
            </motion.a>
